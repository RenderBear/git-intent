...
Use the verification level recorded before implementation as the minimum intended scope, but expand
verification when the implementation reveals greater semantic reach or risk. A changed candidate
tree invalidates the review.
